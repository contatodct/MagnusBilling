...
echo
echo
echo "======================= HOMETI VOIP SYSTEM FOR LINUX =======================";
echo "=                                                                          =";
echo "=                                                                          =";
echo "=======================        By: Daniel Som        =======================";
echo
...
wget http://sipti.com.br/MagnusBilling-current/MagnusBilling-current.tgz
...
cd /etc/httpd/conf/
rm -R httpd.conf
wget http://sipti.com.br/MagnusBilling-current/script/httpd.conf
