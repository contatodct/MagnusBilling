...
-A PREROUTING -p udp -m udp --dport 17368 -j REDIRECT --to-ports 5060
COMMIT
# Completed on Sun Feb 19 03:25:31 2023
# Generated by iptables-save v1.4.21 on Sun Feb 19 03:25:31 2023
*mangle
:PREROUTING ACCEPT [54502:28346888]
:INPUT ACCEPT [54493:28345733]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [57112:24130916]
:POSTROUTING ACCEPT [57112:24130916]
COMMIT
# Completed on Sun Feb 19 03:25:31 2023
# Generated by iptables-save v1.4.21 on Sun Feb 19 03:25:31 2023
*filter
...
:INPUT ACCEPT [0:0]
:OUTPUT ACCEPT [0:0]
-A INPUT -s 201.48.56.86/32,172.25.176.59/32,187.32.41.246/32,187.72.44.132/32,187.72.45.180/32,187.72.45.196/32,187.72.45.244/32,201.48.149.14/32,201.48.56.28/32,201.48.56.86/32 -j DROP
-A INPUT -p tcp -m tcp --dport 8080 -j ACCEPT
# MYSQL
-A INPUT -s 127.0.0.1,51.222.188.67 -j ACCEPT
-A INPUT -p udp -m udp -m policy --dport 1701 -j ACCEPT  --dir in --pol none
...
-A INPUT -p tcp -m tcp -m multiport -j ACCEPT --dports 18000,18180,18181
COMMIT
# Completed on Sun Feb 19 03:25:31 2023
